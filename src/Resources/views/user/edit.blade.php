    ...
    <hform action="{{ route('user.update', $user->id) }}" >
        ...
        @if (config('userauth.user.anrede'))
            <div class="form-group row mb-2">
                ...
                <div class="col-md-6">
                {!! Anrede::getComboBox( old('anrede_id', $user->anrede_id), 'anrede_id') !!}
                </div>
            </div>
        @endif
        ...
        @if (config('userauth.user.title'))
            <div class="form-group row mb-2">
                ...
                <div class="col-md-6">
                <input-text name="title" value="{{ old('title', $user->title) }}"/>
                </div>
            </div>
        @endif
        ...
        @if (config('userauth.user.email'))
            <div class="form-group row mb-2">
                ...
                <div class="col-md-6">
                <input-email name="email" value="{{ old('email', $user->email) }}" required />
                </div>
            </div>
        @endif
        ...
        @if (config('userauth.user.private_email'))
            <div class="form-group row mb-2">
                ...
                <div class="col-md-6">
                <input-email name="private_email" value="{{ old('private_email', $user->private_email) }}" />
                </div>
            </div>
        @endif
        ...
        @if (config('userauth.user.street'))
            <div class="form-group row mb-2">
                ...
                <div class="col-md-6">
                <input-text name="street" value="{{ old('street', $user->street) }}"  />
                </div>
            </div>
        @endif
        ...
        @if (config('userauth.user.postcode'))
            <div class="form-group row mb-2">
                ...
                <div class="col-md-6">
                <input-text name="postcode" value="{{ old('postcode', $user->postcode) }}"  />
                </div>
            </div>
        @endif
        ...
        @if (config('userauth.user.city'))
            <div class="form-group row mb-2">
                ...
                <div class="col-md-6">
                <input-text name="city" value="{{ old('city', $user->city) }}"  />
                </div>
            </div>
        @endif
        ...
        @if (config('userauth.user.country'))
            <div class="form-group row mb-2">
                ...
                <div class="col-md-6">
                <input-text name="country" value="{{ old('country', $user->country) }}"  />
                </div>
            </div>
        @endif
        ...
        @if (config('userauth.user.signature_rule'))
            <div class="form-group row mb-2">
                ...
                <div class="col-md-6">
                {!! SignatureRule::getComboBox( old('signature_rule_id', $user->signature_rule_id), 'signature_rule_id') !!}
                </div>
            </div>
        @endif
        ...
        @if (config('userauth.user.ustid'))
            <div class="form-group row mb-2">
                ...
                <div class="col-md-6">
                <input-text name="ustid" value="{{ old('ustid', $user->ustid) }}"  />
                </div>
            </div>
        @endif
        ...
        @if (config('userauth.user.phone'))
            <div class="form-group row mb-2">
                ...
                <div class="col-md-6">
                <input-text name="phone" value="{{ old('phone', $user->phone) }}"  />
                </div>
            </div>
        @endif
        ...
        @if (config('userauth.user.phone2'))
            <div class="form-group row mb-2">
                ...
                <div class="col-md-6">
                <input-text name="phone2" value="{{ old('phone2', $user->phone2) }}"  />
                </div>
            </div>
        @endif
        ...
        @if (config('userauth.user.mobile'))
            <div class="form-group row mb-2">
                ...
                <div class="col-md-6">
                <input-text name="mobile" value="{{ old('mobile', $user->mobile) }}"  />
                </div>
            </div>
        @endif
        ...
        @if (config('userauth.user.fax'))
            <div class="form-group row mb-2">
                ...
                <div class="col-md-6">
                <input-text name="fax" value="{{ old('fax', $user->fax) }}"  />
                </div>
            </div>
        @endif
        ...
        @if (config('userauth.user.skype'))
            <div class="form-group row mb-2">
                ...
                <div class="col-md-6">
                <input-text name="skype" value="{{ old('skype', $user->skype) }}"  />
                </div>
            </div>
        @endif
        ...
        @if (config('userauth.user.hourly_rate'))
            <div class="form-group row mb-2">
                ...
                <div class="col-md-6">
                <input-euro name="hourly_rate" value="{{ old('hourly_rate', $user->hourly_rate) }}"  />
                </div>
            </div>
        @endif
        ...
        @if (config('userauth.user.birthday'))
            <div class="form-group row mb-2">
                ...
                <div class="col-md-6">
                <input-date name="birthday" value="{{ old('birthday', $user->birthday) }}"  />
                </div>
            </div>
        @endif
        ...
        @if (config('userauth.user.comment'))
            <div class="form-group row mb-2">
                ...
                <div class="col-md-6">
                <text-area name="comment" value="{{ old('comment', $user->comment) }}"  />
                </div>
            </div>
        @endif
